...
export type Query = {
  ...
  workoutsByUser?: Maybe<Array<Maybe<Workout>>>;
};
...
export type QueryWorkoutsByUserArgs = {
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  workoutsByUser?: Resolver<Maybe<Array<Maybe<ResolversTypes['Workout']>>>, ParentType, ContextType, Partial<QueryWorkoutsByUserArgs>>;
};
