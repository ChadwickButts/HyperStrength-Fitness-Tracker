...
export const resolvers: Resolvers = {
    Query: {
        ...
        workoutsByUser: async (parent: any, args: any, context: any ) => { 
            return await context.db<Workout[]>`SELECT * FROM public.workouts 
            WHERE userid = ${args.userid} ORDER BY date DESC`
        },
